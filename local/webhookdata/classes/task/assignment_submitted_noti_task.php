...
class assignment_submitted_noti_task extends \core\task\adhoc_task
{
    public function get_name()
    {
        return get_string("assignmensubmit", "local_webhookdata");
    }
    ...
    public function execute()
    {
        ...
        $eventdata->event = 'MOODLE_ASSIGNMENT_SUBMIT';
